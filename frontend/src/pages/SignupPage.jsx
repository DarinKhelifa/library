...
const SignupPage = () => {
  ...
  return (
    <div className='min-h-screen flex items-center justify-center bg-gradient-to-br from-[#FFF8F3] via-[#F8E7F6] to-[#F6E7D7] px-4'>
      <form onSubmit={handleSignup} className='flex flex-col w-full max-w-xl mx-auto space-y-6 bg-white bg-opacity-90 rounded-2xl shadow-xl p-8 border border-[#F8E7F6]'>
        ...
        <div className='flex flex-col w-full'>
          <label className='md:text-lg mb-1'>Username :</label>
          <input
            type="text"
            value={username}
        ...
        <div className='flex flex-col w-full'>
          <label className='md:text-lg mb-1'>Confirm Password :</label>
          <input
            type="password"
        ...
        <p className="text-center">
          Already have an account? <Link to={"/login"} className="text-[#944424] underline hover:text-[#4B164C]">Log in</Link>
        </p>
      </form>
    </div>
  )
